...
namespace CondorEngine
{
	...
	class DllExport SceneObject : public Object
	{
		friend Scene;
...
#pragma region Component Methods
	public:
		...
		template <typename T>
		bool TryFindComponent(T **component)
		{
		...
		/// @return True if it found a Component of type `T`, false if it did not.
		template <typename T>
		bool TryFindComponentInChildren(T **component)
		{
			if (TryFindComponent<T>(component))
			{
				return true;
		...
		/// @return True if it found a Component of type `T`, false if it did not.
		template <typename T>
		bool TryFindComponentInParent(T **component)
		{
			if (TryFindComponent<T>(component))
			{
				return true;
